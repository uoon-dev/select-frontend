...
export const CardIconComponent = (props: { className: string; }) => (
...
export const CoinBoldComponent = (props: { className: string; }) => (
  <svg x="0px" y="0px" width="48px" height="34px" viewBox="0 0 48 34" {...props}>
    {/* tslint:disable-next-line:max-line-length */}
...
export const SettingMenu: React.FunctionComponent<SettingMenuStateProps> = ({ children }) => {
