...
const ErrorImageComponent = () => (
  <svg width={94} height={79}>
    <g fill="none">
      <path
      ...
      <path
        fill="#B8BFC4"
        {/* tslint:disable-next-line:max-line-length */}
        d="M32.674 30.736l4.308 4.308-1.938 1.938-4.308-4.308-4.308 4.308-1.938-1.938 4.308-4.308-4.308-4.308 1.938-1.938 4.308 4.308 4.308-4.308 1.938 1.938zm35.641 4.308l-1.938 1.938-4.308-4.308-4.308 4.308-1.938-1.938 4.308-4.308-4.308-4.308 1.938-1.938 4.308 4.308 4.308-4.308 1.938 1.938-4.308 4.308zm-8.63 14.937v2.741h-25.37v-2.74z"
      />
    </g>
  </svg>
);
