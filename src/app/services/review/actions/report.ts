...
export type ActionPostReviewReportSuccess = Action<typeof POST_REVIEW_REPORT_SUCCESS, {
  bookId: number,
  reviewId: number,
}>
...
export const postReviewReportSuccess = (
  bookId: number,
  reviewId: number,
): ActionPostReviewReportSuccess => ({ type: POST_REVIEW_REPORT_SUCCESS, payload: { bookId, reviewId } });
