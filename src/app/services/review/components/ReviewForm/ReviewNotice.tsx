...
export const ReviewNotice: React.FunctionComponent = () => (
  <div className="ReviewForm_Notice">
    <p className="ReviewForm_Notice_P">
      건전한 리뷰 정착 및 양질의 리뷰를 위해 아래 해당하는 리뷰는 비공개 조치될 수 있음을
      안내드립니다.
    </p>
    <ol className="ReviewForm_Notice_List">
      ...
      <li className="ReviewForm_Notice_List_Item">
      ...
      <li className="ReviewForm_Notice_List_Item-extra">
        * 결말을 예상할 수 있는 리뷰는 자제하여 주시기 바랍니다.
      </li>
    </ol>
    <p className="ReviewForm_Notice_P">
      이 외에도 건전한 리뷰 문화 형성을 위한 운영 목적과 취지에 맞지 않는 내용은 담당자에 의해
      리뷰가 비공개 처리가 될 수 있습니다.
    </p>
  </div>
);
