...
): Promise<AxiosResponse<ResponseReviews>> =>
  request({
...
export const requestPostReview = (
  ...
  content: TextWithLF,
  hasSpoiler: boolean,
): Promise<AxiosResponse<ResponseDataReview>> =>
  request({
...
export const requestDeleteReview = (bookId: number): Promise<AxiosResponse<ResponseDataReview>> =>
  request({
    url: `${env.STORE_API}/api/select/books/${bookId}/reviews/my/content`,
    method: 'DELETE',
  }).then((response: AxiosResponse<object>) =>
...
export const requestDeleteRating = (
  bookId: number,
): Promise<AxiosResponse<DeleteRatingResponseDataReview>> =>
  request({
    url: `${env.STORE_API}/api/select/books/${bookId}/reviews/my/rating`,
    method: 'DELETE',
  }).then((response: AxiosResponse<object>) =>
...
export const requestLikeReview = (bookId: number, reviewId: number): Promise<AxiosResponse> =>
  request({
    url: `${env.STORE_API}/api/select/books/${bookId}/reviews/${reviewId}/like`,
    method: 'POST',
  });

export const requestCancelReviewLike = (bookId: number, reviewId: number): Promise<AxiosResponse> =>
  request({
    url: `${env.STORE_API}/api/select/books/${bookId}/reviews/${reviewId}/like`,
    method: 'DELETE',
  });
...
export const requestPostComment = (
  ...
  reviewId: number,
  content: TextWithLF,
): Promise<AxiosResponse<ResponseComment>> =>
  request({
