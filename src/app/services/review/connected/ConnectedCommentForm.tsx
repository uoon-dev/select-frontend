...
import { CommentForm, CommentFormProps } from 'app/services/review/components/CommentList';
import { getReviewFetchStatus } from 'app/services/review/selectors';
import { getCommentInputContent } from 'app/services/review/selectors/comments';
import { RidiSelectState } from 'app/store';
import { Omit } from 'app/types';

export type CommentFormStateProps = Pick<CommentFormProps, 'content' | 'isSubmitting'>;
...
function mapStateToProps(
  ...
  return {
    ...
    isSubmitting:
      (getReviewFetchStatus(state, ownProps) || {}).myComment === FetchStatusFlag.FETCHING,
  };
}

export type CommentFormDispatchProps = Pick<CommentFormProps, 'onChange' | 'onSubmit'>;

function mapDispatchToProps(dispatch: Dispatch<RidiSelectState>): CommentFormDispatchProps {
  return {
