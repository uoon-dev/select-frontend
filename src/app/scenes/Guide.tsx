        ...
        <ol className="Guide_List">
            ...
            <p className="Guide_Item_Content grid">
              ...
              <span className="Guide_Item_Content_Right">
                <img
                  ...
                  src={require('images/guide/guide_ridibooks.jpg')}
                  alt=""
                />
                <Button
                  component="a"
          ...
          <li className="Guide_Item">
            ...
            <p className="Guide_Item_Content">
              ...
              <img
                className="Guide_Image"
                src={require(`images/guide/guide_home_${FREE_PROMOTION_MONTHS}.jpg`)}
                alt=""
              />
            </p>
          </li>
          <li className="Guide_Item">
            ...
            <p className="Guide_Item_Content">
              ...
              <img
                className="Guide_Image"
                src={require('images/guide/guide_detail.jpg')}
                alt=""
              />
            </p>
          </li>
          ...
          <li className="Guide_Item">
            ...
            <p className="Guide_Item_Content">
              ...
              <img
                className="Guide_Image"
                src={require('images/guide/guide_download.jpg')}
                alt=""
              />
            </p>
          </li>
